...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  fragColor = vec4(col, clamp(length(col) * 3.0, 0.0, 1.0));
}
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Window-level events so the interactive effect works even when the
    // canvas is positioned behind content elements (z-index / pointer-events).
